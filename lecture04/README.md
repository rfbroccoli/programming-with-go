# topics covered
 ...
 1. switch (`switch variable case check-if-variable-equal-to-this: {}`) 
 2. input (`bufio.NewReader`, `os.Stdin`)
 3. random (`seed := rand.NewSource`, `random := rand.New()`) 
 4. rock paper scissors with AI in go 
